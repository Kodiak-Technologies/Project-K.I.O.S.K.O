// Controles de paginación: page_size, prev/next, total.
// Reutilizado en TODAS las páginas con listas paginadas del módulo.
import { ChevronLeft, ChevronRight } from "lucide-react";
import { Button, Select } from "../../../shared/components/ui";
import type { PaginadosResponse } from "../types";

interface Props<T> {
  /** Respuesta paginada cruda del backend. Si es `null`, no renderiza nada. */
  paginados: PaginadosResponse<T> | null;
...
export function PaginacionControles<T>({
  paginados,
  page,
  onCambiarPage,
  pageSize,
