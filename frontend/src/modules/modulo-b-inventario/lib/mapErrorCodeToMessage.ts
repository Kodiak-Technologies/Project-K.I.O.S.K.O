...
const MAP: Record<ErrorCodeBackend, string> = {
  ...
  NOT_EDITABLE_STATE: "Esta solicitud/merma ya no se puede editar (cambió de estado). Refrescá la lista.",
  FORBIDDEN: "No tenés permiso para editar esta solicitud/merma.",
  ...
  INVALID_MOTIVO: "El motivo debe ser: vencimiento, rotura u otro.",
  ...
  MERMA_NOT_FOUND: "La merma no existe o fue eliminada.",
  ALREADY_REJECTED: "Esta solicitud/merma ya fue rechazada.",
