...
export function ModalCobro({
  ...
  const infoSimple = useMemo(
    () => metodos.find((m) => m.codigo === metodoSimple),
  ...
  const sumaMixto = metodos.reduce((suma, m) => {
  ...
  const montoEfectivoMixto = metodos
